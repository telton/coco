...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p style="margin-top: 2em; text-align:center;" class="alert alert-dark"><strong>Use the navigation panel to view the course assignments, your notes, grades, or access chat.</strong></p>
    </div>
</div>
